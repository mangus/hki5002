...
<body>
<a href="https://github.com/mangus/hki5002" class="github-corner" aria-label="View source on Github">
...
<div class="page-wrap container">
    <h1 class="main-heading">Programmeerimine I
        <small>HKI5002</small>
    </h1>
        ...
        <div class="row">
            <div class="col s6">
                ...
                <ul>
                    ...
                    <li><a href="sess5/">5. sessioon</a> (1. juuni 2017)</li>
                    <li><a href="eksam/">Eksam</a> (15. juuni 2017)</li>
                </ul>
                </span>
            </div>
            <div class="col s6">
    ...
    <div class="section">
        ...
        <table class="striped" style="table-layout:fixed;">
            ...
            <tr>
                <td>10</td>
                <td>Tegele oma koduse projektiga, aruandes kirjuta progressist.</td>
    ...
    <div class="section">
        <blockquote>
            <h4>Jututuba</h4>
            <p>
                Kui tegeled aine teemadega, siis ilmuta end ka <a target="_blank" href="https://gitter.im/hki5002/">jututoas</a>!<br/>
    ...
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                <h5 class="white-text">Programmeerimine I HKI5002</h5>
                <p class="grey-text text-lighten-4">HKI5002 / 2017 kevadsemester</p>
            </div>
